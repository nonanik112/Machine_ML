    ...
    class Program
    {
        static void Main(string[] args)
        {
           var context = new MLContext();
            ...
            {
                MaxExperimentTimeInSeconds = 150,
            ...
            var results = experiment.Execute(trainTestSplit.TrainSet, validationData:trainTestSplit.TrainSet, progressHandler: progressHandler);
